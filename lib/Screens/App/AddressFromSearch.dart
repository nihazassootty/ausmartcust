...
class MapFromSearch extends StatefulWidget {
  var result;
  MapFromSearch({Key key, this.result}) : super(key: key);

  @override
  _MapFromSearchState createState() => _MapFromSearchState();
}

class _MapFromSearchState extends State<MapFromSearch>
    ...
    if (permission == LocationPermission.denied) {
      ...
      setState(() {
        ...
        currentLocation = CameraPosition(
          target: LatLng(widget.result["geometry"]["location"]["lat"],
